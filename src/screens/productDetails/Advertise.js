                                ...
                                <div className="tab-content">
                                    <div className="row">
                                        <div className="col-md-8">
                                            Adopta siempre con responsabilidad 
                                        </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <h5> Location: {ad && ad.area},{ad && ad.región} </h5>
                                    </div>
                                    <div className="col-md-6">
                                    </div>
                                </div>
                                    ...
                                    {relatedAds && relatedAds.map((relatedAd, index) => {
                                        return <div key={index} className="col-md-2">
                                            <Link to={`/product-details/${relatedAd._id}`} className="product">
                                                ...
                                                <div className="mb-3">
                                                    <span className="mr-3"> <MdLocationOn /> {`${relatedAd.area},${relatedAd.región}`} </span> <p> edad: {relatedAd.edad} BDT </p>
                                                </div>
                                            </Link>
                                        </div>
                                    })}
